...
# 获取有效 config.sh 链接
get_valid_config() {
    config_list=(https://raw.githubusercontents.com/xjy0320/fakerVIP/main/Conf/Qinglong/config.sample.sh https://raw.sevencdn.com/xjy0320/fakerVIP/main/Conf/Qinglong/config.sample.sh https://git.metauniverse-cn.com/https://raw.githubusercontent.com/xjy0320/fakerVIP/main/Conf/Qinglong/config.sample.sh)
...
# 获取有效 extra.sh 链接
get_valid_extra() {
    extra_list=(https://raw.githubusercontents.com/xjy0320/fakerVIP/main/Tasks/qlrepo/extra.sh https://raw.sevencdn.com/xjy0320/fakerVIP/main/Tasks/qlrepo/extra.sh https://git.metauniverse-cn.com/https://raw.githubusercontent.com/xjy0320/fakerVIP/main/Tasks/qlrepo/extra.sh)
...
# 获取有效 code.sh 链接
get_valid_code() {
    code_list=(https://raw.githubusercontents.com/xjy0320/fakerVIP/main/Scripts/sh/Helpcode2.8/code.sh https://raw.sevencdn.com/xjy0320/fakerVIP/main/Scripts/sh/Helpcode2.8/code.sh https://git.metauniverse-cn.com/https://raw.githubusercontents.com/xjy0320/fakerVIP/main/Scripts/sh/Helpcode2.8/code.sh)
...
get_valid_task_before() {
    task_before_list=(https://raw.githubusercontents.com/xjy0320/fakerVIP/main/Scripts/sh/Helpcode2.8/task_before.sh https://raw.sevencdn.com/xjy0320/fakerVIP/main/Scripts/sh/Helpcode2.8/task_before.sh https://git.metauniverse-cn.com/https://raw.githubusercontents.com/xjy0320/fakerVIP/main/Scripts/sh/Helpcode2.8/task_before.sh)
...
run_curl_sample() {
    curl -sL $valid_url -o /ql/sample/config.sample.sh && cp -rf /ql/sample/config.sample.sh /ql/data/config/config.sample.sh
}
if [ "${all}" = 1 ]; then
